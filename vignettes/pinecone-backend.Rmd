---
title: "RAG with Pinecone Backend"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{RAG with Pinecone Backend}
...
- Match `embedding_function` and `embedding_dim` to the vectors stored in Pinecone.
