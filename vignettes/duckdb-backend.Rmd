---
title: "RAG with DuckDB Backend"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{RAG with DuckDB Backend}
...
- For production, use a real embedding function (for example `embed_openai()`).
