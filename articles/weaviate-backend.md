...
- Your Weaviate class should include text fields such as `page_content`,
  `text`, or `content`.
- Ensure query embeddings use the same vector setup used during
  ingestion.
